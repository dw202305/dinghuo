...
-- 版本：v1.1
-- 日期：2026-08-17
-- 变更：金额字段统一 BIGINT(分)、尺寸字段加单位后缀、新增储值/归属/价格版本表
-- ============================================================
...
-- 2.1 门店主体表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_store` (
...
-- 2.2 城市合伙人主体表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_partner` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.3 门店联系人表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_store_contact` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `contact_type` TINYINT NOT NULL DEFAULT 1 COMMENT '联系人类型：1负责人 2采购 3下单 4财务 5安装 6售后 7收货人',
...
-- 2.4 登录账号表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_account` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `phone` VARCHAR(20) NOT NULL COMMENT '登录手机号',
  `password_hash` VARCHAR(255) DEFAULT NULL COMMENT '密码哈希，微信登录用户为空',
  ...
  `account_role` TINYINT NOT NULL DEFAULT 2 COMMENT '账号角色：1门店管理员 2下单员 3财务 4安装售后 5只读 6运营 7销售 8财务(总部) 9超管',
  `status` TINYINT NOT NULL DEFAULT 1 COMMENT '状态：1正常 0停用',
...
-- 2.4.2 后台角色表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_admin_role` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.4.3 后台权限表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_admin_permission` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.4.4 角色权限关联表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_admin_role_permission` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `role_id` BIGINT UNSIGNED NOT NULL COMMENT '角色ID',
...
-- 2.5 账号与客户主体关联表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_account_customer` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.6 收货地址表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_store_address` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `store_id` BIGINT UNSIGNED NOT NULL COMMENT '所属门店ID',
...
-- -----------------------------------------------------------
-- 2.7 公司销售人员表（PRD 15.8）
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_sales` (
  ...
  `supervisor_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '上级销售ID',
  `crm_user_id` VARCHAR(64) DEFAULT NULL,
  `employment_status` TINYINT NOT NULL DEFAULT 1 COMMENT '1在职 2离职',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='公司销售人员';

-- -----------------------------------------------------------
-- 2.8 订单表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_order` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `trade_subject_type` VARCHAR(20) DEFAULT NULL COMMENT '交易主体类型(store/partner)',
  `service_store_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '实际服务门店ID，合伙人自营为空',
  `actual_store_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '实际服务门店ID',
  ...
  `fabric_area_total` DECIMAL(12,4) NOT NULL DEFAULT 0 COMMENT '面料总面积(㎡)',
  ...
  `refund_amount_cent` BIGINT NOT NULL DEFAULT 0 COMMENT '退款金额(分)',
  ...
  `price_version_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '价格版本ID',
  `idempotent_key` VARCHAR(128) DEFAULT NULL COMMENT '幂等键',
  `ownership_decided_at` DATETIME DEFAULT NULL COMMENT '归属确定时间',
  `ownership_rule` VARCHAR(50) DEFAULT NULL COMMENT '归属规则',
...
-- 2.9 窗帘明细表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_order_item` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `track_horizontal_length` DECIMAL(8,1) NOT NULL COMMENT '横轨长度(米)',
  `track_vertical_length` DECIMAL(8,1) NOT NULL COMMENT '竖轨总长度(米)',
  ...
  `nonstandard_fee_cent` BIGINT NOT NULL DEFAULT 0 COMMENT '非标费用(分)',
  `subtotal_amount_cent` BIGINT NOT NULL COMMENT '单副合计(分)',
...
-- 2.10 门店套件库存表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_store_inventory` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `idempotent_key` VARCHAR(128) DEFAULT NULL COMMENT '库存操作幂等键',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- 2.11 库存流水表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_inventory_log` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `store_id` BIGINT UNSIGNED NOT NULL COMMENT '门店ID',
  ...
  `idempotent_key` VARCHAR(128) DEFAULT NULL COMMENT '流水操作幂等键',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- 2.12 面料表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_fabric` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `price_per_m2_cent` BIGINT NOT NULL COMMENT '单价(分/㎡)',
  ...
  `min_billing_area` DECIMAL(10,4) DEFAULT NULL COMMENT '最小计费面积',
...
-- 2.13 面料供应商表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_fabric_supplier` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.14 面料供应商映射表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_fabric_supplier_mapping` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.15 轨道表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_track` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `price_per_meter_cent` BIGINT NOT NULL COMMENT '门店单价(分/米)',
...
-- 2.16 选装配件表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_accessory` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `upgrade_price_cent` BIGINT DEFAULT NULL COMMENT '升级价格(分)',
...
-- 2.17 支付记录表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_payment` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `payment_no` VARCHAR(50) NOT NULL COMMENT '支付单号',
  `order_id` BIGINT UNSIGNED NOT NULL COMMENT '订单ID',
  `order_no` VARCHAR(50) NOT NULL COMMENT '订单号',
  `pay_channel` TINYINT NOT NULL COMMENT '支付渠道：1余额 2微信 3支付宝',
  `payment_channel` VARCHAR(20) NOT NULL DEFAULT 'wechat' COMMENT '支付渠道：wechat/alipay/balance/manual',
  ...
  `idempotent_key` VARCHAR(128) DEFAULT NULL COMMENT '幂等键',
  `balance_transaction_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '余额流水ID',
...
-- 2.18 操作日志表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_operation_log` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_oplog_operator_id` (`operator_id`),
...
-- 2.19 售后申请表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_after_sale` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 2.20 发票申请表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_invoice_request` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------------
-- 2.21 归属关系历史（PRD 15.7）
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_customer_attribution_history` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `customer_type` VARCHAR(20) NOT NULL COMMENT 'store/partner',
  `customer_id` BIGINT UNSIGNED NOT NULL,
  `channel_mode` VARCHAR(20) NOT NULL COMMENT 'partner_channel/direct',
  `partner_id` BIGINT UNSIGNED DEFAULT NULL,
  `primary_sales_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '主归属销售',
  `secondary_sales_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '协同销售',
  `source` VARCHAR(20) NOT NULL COMMENT 'develop/assign/inherit/transfer/migrate',
  `effective_at` DATETIME NOT NULL,
  `expires_at` DATETIME DEFAULT NULL,
  `is_current` TINYINT NOT NULL DEFAULT 1,
  `change_reason` VARCHAR(500) DEFAULT NULL,
  `is_cascade` TINYINT NOT NULL DEFAULT 0 COMMENT '是否由合伙人变更级联',
  `parent_relation_id` BIGINT UNSIGNED DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='归属关系历史';

-- -----------------------------------------------------------
-- 2.22 客户资金账户（PRD 15.10）
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_customer_balance_account` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `customer_type` VARCHAR(20) NOT NULL COMMENT '主体类型: store/partner',
  `customer_id` BIGINT UNSIGNED NOT NULL COMMENT '主体ID',
  `currency` VARCHAR(3) NOT NULL DEFAULT 'CNY',
  `available_balance` BIGINT NOT NULL DEFAULT 0 COMMENT '可用余额(分)',
  `frozen_balance` BIGINT NOT NULL DEFAULT 0 COMMENT '冻结余额(分)',
  `total_recharge` BIGINT NOT NULL DEFAULT 0 COMMENT '累计储值(分)',
  `total_consumed` BIGINT NOT NULL DEFAULT 0 COMMENT '累计消费(分)',
  `total_refund` BIGINT NOT NULL DEFAULT 0 COMMENT '累计退款(分)',
  `total_adjustment` BIGINT NOT NULL DEFAULT 0 COMMENT '累计调整(分)',
  `status` TINYINT NOT NULL DEFAULT 1 COMMENT '1正常 2冻结 3注销',
  `version` INT NOT NULL DEFAULT 0 COMMENT '乐观锁版本号',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` DATETIME DEFAULT NULL,
  UNIQUE KEY `uk_customer_currency` (`customer_type`, `customer_id`, `currency`),
  INDEX `idx_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='客户资金账户';

-- -----------------------------------------------------------
-- 2.23 客户资金流水（PRD 15.11）
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_customer_balance_transaction` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `transaction_no` VARCHAR(64) NOT NULL COMMENT '流水号',
  `account_id` BIGINT UNSIGNED NOT NULL,
  `customer_type` VARCHAR(20) NOT NULL,
  `customer_id` BIGINT UNSIGNED NOT NULL,
  `transaction_type` VARCHAR(20) NOT NULL COMMENT 'recharge/consume/refund/freeze/unfreeze/adjust/transfer/reversal',
  `fund_type` TINYINT NOT NULL DEFAULT 1 COMMENT '1真实 2测试',
  `amount` BIGINT NOT NULL COMMENT '变动金额(分)，正数入账负数出账',
  `direction` TINYINT NOT NULL COMMENT '1入 2出',
  ...
  `ref_payment_no` VARCHAR(64) DEFAULT NULL COMMENT '关联支付单号',
  `ref_recharge_no` VARCHAR(64) DEFAULT NULL COMMENT '关联储值单号',
  `ref_refund_no` VARCHAR(64) DEFAULT NULL COMMENT '关联退款单号',
  `idempotent_key` VARCHAR(128) NOT NULL COMMENT '唯一业务幂等键',
  `payment_channel` VARCHAR(20) DEFAULT NULL COMMENT 'wechat/alipay/balance/manual',
...
-- 2.24 储值订单（PRD 15.12）
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `lj_recharge_order` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `recharge_no` VARCHAR(64) NOT NULL COMMENT '储值单号',
  `account_id` BIGINT UNSIGNED NOT NULL,
  `customer_type` VARCHAR(20) NOT NULL,
  `customer_id` BIGINT UNSIGNED NOT NULL,
  `amount_cent` BIGINT NOT NULL COMMENT '储值金额(分)',
  `recharge_method` VARCHAR(20) NOT NULL COMMENT 'wechat/alipay/offline/test',
  `platform_transaction_no` VARCHAR(128) DEFAULT NULL COMMENT '支付平台交易号',
  `offline_voucher` VARCHAR(255) DEFAULT NULL COMMENT '线下凭证',
  `offline_payer` VARCHAR(100) DEFAULT NULL COMMENT '线下付款人',
  `offline_receiver_account` VARCHAR(100) DEFAULT NULL COMMENT '收款账户',
  `status` TINYINT NOT NULL DEFAULT 0 COMMENT '0待支付 1已支付待审核 2已入账 3审核驳回 4已退款 5已关闭',
  ...
  UNIQUE KEY `uk_idempotent` (`idempotent_key`),
  UNIQUE KEY `uk_platform_txn` (`platform_transaction_no`),
  INDEX `idx_account` (`account_id`),
  INDEX `idx_customer` (`customer_type`, `customer_id`),
  INDEX `idx_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='储值订单';
